...
class MinvoiceHandler(BaseSyncHandler):
    """Handle Minvoice data synchronization."""
    
    # Script files for Minvoice
    SYNC_SCRIPTS = {
        "all": [
            "script_minvoice/minvoice_ingest.py",
        ]
    }
    ...
    def handle_sync(self, sync_type: str = "all") -> Dict[str, Any]:
        """Handle Minvoice synchronization."""
        ...
        try:
            ...
            # Log tổng kết Minvoice sau khi chạy xong tất cả script
            ...
            self.logger.info(
                "Minvoice summary | success: %s | failed: %s",
                success_scripts or "[]",
                failed_scripts or "[]",
                extra={
                    "handler": "MinvoiceHandler",
                    "sync_type": sync_type,
    ...
    def _run_script(self, script_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Một số script dùng hàm `main`, một số có thể dùng `if __name__ == '__main__'`
